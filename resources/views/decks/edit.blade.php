                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 overflow-hidden">
                            <div class="p-6 bg-gradient-to-r from-indigo-600 to-purple-600">
                                ...
                                <p class="text-white/70 text-sm">Modifiez les cartes du deck</p>
                            </div>
                            ...
                            <div class="p-6">
                                @if($collection->isEmpty())
                                    <div class="text-center py-12">
                                        ...
                                        <p class="text-gray-400">Achetez des boosters pour obtenir des cartes !</p>
                                    </div>
                                @else
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            cardSelectors.forEach(selector => {
                ...
                let quantity = parseInt(selector.dataset.current) || 0;
                ...
                function updateDisplay() {
                    ...
                    if (quantity > 0) {
                        ...
                        container.classList.add('ring-2', 'ring-purple-500', 'border-purple-500');
                        container.classList.remove('border-white/10');
                    } else {
                        overlay.style.opacity = '0';
                        controls.classList.add('hidden');
                        container.classList.remove('ring-2', 'ring-purple-500', 'border-purple-500');
