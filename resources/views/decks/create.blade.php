                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name') }}"
                                        required placeholder="Ex: Les Chevaliers d'Or"
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="3" placeholder="Décrivez votre stratégie..."
                                ...
                                <!-- Bouton submit -->
                                <button type="submit"
                                    class="w-full py-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold text-lg rounded-lg hover:from-purple-500 hover:to-indigo-500 transition transform hover:scale-[1.02]">
                                    ✅ Créer le deck
                                </button>
                            </div>
                        </div>
                                ...
                                @if ($collection->isEmpty())
                                    <div class="text-center py-12">
                                        ...
                                        <a href="{{ route('shop.index') }}"
                                            class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold rounded-lg hover:from-purple-500 hover:to-indigo-500 transition">
                                            🛒 Aller à la boutique
                                        </a>
                                    </div>
                                @else
                                        ...
                                        @foreach ($collection as $card)
                                            <div class="card-selector group" data-card-id="{{ $card->id }}"
                                                ...
                                                <div class="relative bg-white/5 rounded-xl border-2 border-white/10 overflow-hidden transition-all duration-300 hover:border-purple-500/50 cursor-pointer"
                                                    ...
                                                    <div
                                                        class="absolute inset-0 bg-purple-600/50 opacity-0 transition-opacity flex items-center justify-center selected-overlay">
                                                    ...
                                                    <div
                                                        class="quantity-controls hidden absolute bottom-16 left-0 right-0 bg-black/80 p-2 flex items-center justify-center gap-3">
                                                        <button type="button"
                                                            class="qty-btn qty-minus w-8 h-8 rounded-full bg-red-600 text-white font-bold hover:bg-red-500">-</button>
                                                        <span
                                                            class="qty-display text-white font-bold text-lg w-8 text-center">0</span>
                                                        <button type="button"
