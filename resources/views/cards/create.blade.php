    ...
    <div class="min-h-screen bg-gradient-to-b from-gray-800 via-gray-900 to-black py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 overflow-hidden">
                ...
                <form method="POST" action="{{ route('admin.cards.store') }}" enctype="multipart/form-data" class="p-6 space-y-8">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="grade" id="grade" value="{{ old('grade', 5) }}" min="1" max="10" required
                            ...
                            <div>
                                ...
                                <select name="faction_id" id="faction_id" required
                                    ...
                                    @foreach($factions as $faction)
                                        <option value="{{ $faction->id }}" {{ old('faction_id') == $faction->id ? 'selected' : '' }}>
                                            {{ $faction->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" name="cost" id="cost" value="{{ old('cost', 3) }}" min="1" max="15" required
                                       class="w-full bg-white/10 border border-white/30 rounded-lg px-4 py-3 text-white focus:border-purple-500 focus:ring-purple-500">
                                @error('cost')
                                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <select name="armor_type" id="armor_type" required
                                        class="w-full bg-white/10 border border-white/30 rounded-lg px-4 py-3 text-white focus:border-purple-500 focus:ring-purple-500">
                                    <option value="bronze" {{ old('armor_type') == 'bronze' ? 'selected' : '' }}>🥉 Bronze</option>
                                    <option value="silver" {{ old('armor_type') == 'silver' ? 'selected' : '' }}>🥈 Argent</option>
                                    <option value="gold" {{ old('armor_type') == 'gold' ? 'selected' : '' }}>🥇 Or</option>
                                    <option value="divine" {{ old('armor_type') == 'divine' ? 'selected' : '' }}>👑 Divine</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="element" id="element" required
                                        class="w-full bg-white/10 border border-white/30 rounded-lg px-4 py-3 text-white focus:border-purple-500 focus:ring-purple-500">
                                    <option value="fire" {{ old('element') == 'fire' ? 'selected' : '' }}>🔥 Feu</option>
                                    <option value="water" {{ old('element') == 'water' ? 'selected' : '' }}>💧 Eau</option>
                                    <option value="ice" {{ old('element') == 'ice' ? 'selected' : '' }}>❄️ Glace</option>
                                    <option value="thunder" {{ old('element') == 'thunder' ? 'selected' : '' }}>⚡ Foudre</option>
                                    <option value="darkness" {{ old('element') == 'darkness' ? 'selected' : '' }}>🌑 Ténèbres</option>
                                    <option value="light" {{ old('element') == 'light' ? 'selected' : '' }}>✨ Lumière</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="rarity" id="rarity" required
                                        class="w-full bg-white/10 border border-white/30 rounded-lg px-4 py-3 text-white focus:border-purple-500 focus:ring-purple-500">
                                    <option value="common" {{ old('rarity') == 'common' ? 'selected' : '' }}>Commune</option>
                                    <option value="rare" {{ old('rarity') == 'rare' ? 'selected' : '' }}>Rare</option>
                                    <option value="epic" {{ old('rarity') == 'epic' ? 'selected' : '' }}>Épique</option>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                            <div class="bg-red-500/20 border border-red-500/30 rounded-xl p-4">
                                ...
                                <input type="number" name="health_points" id="health_points" value="{{ old('health_points', 100) }}" min="1" max="500" required
                            ...
                            <div class="bg-yellow-500/20 border border-yellow-500/30 rounded-xl p-4">
                                ...
                                <input type="number" name="endurance" id="endurance" value="{{ old('endurance', 80) }}" min="1" max="200" required
                            ...
                            <div class="bg-blue-500/20 border border-blue-500/30 rounded-xl p-4">
                                ...
                                <input type="number" name="defense" id="defense" value="{{ old('defense', 30) }}" min="0" max="100" required
                            ...
                            <div class="bg-orange-500/20 border border-orange-500/30 rounded-xl p-4">
                                ...
                                <input type="number" name="power" id="power" value="{{ old('power', 50) }}" min="0" max="200" required
                            ...
                            <div class="bg-purple-500/20 border border-purple-500/30 rounded-xl p-4">
                                ...
                                <input type="number" name="cosmos" id="cosmos" value="{{ old('cosmos', 60) }}" min="0" max="200" required
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
                                ...
                                <select name="main_attack_id" id="main_attack_id" required
                                    ...
                                    @foreach($attacks as $attack)
                                        <option value="{{ $attack->id }}" {{ old('main_attack_id') == $attack->id ? 'selected' : '' }}>
                            ...
                            <div class="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
                                ...
                                <select name="secondary_attack_1_id" id="secondary_attack_1_id"
                                    ...
                                    @foreach($attacks as $attack)
                                        <option value="{{ $attack->id }}" {{ old('secondary_attack_1_id') == $attack->id ? 'selected' : '' }}>
                                            {{ $attack->name }} ({{ $attack->damage }} DMG)
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                                ...
                                <select name="secondary_attack_2_id" id="secondary_attack_2_id"
                                    ...
                                    <option value="">-- Aucune --</option>
                                    @foreach($attacks as $attack)
                                        <option value="{{ $attack->id }}" {{ old('secondary_attack_2_id') == $attack->id ? 'selected' : '' }}>
                                            {{ $attack->name }} ({{ $attack->damage }} DMG)
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="passive_ability_name" id="passive_ability_name" value="{{ old('passive_ability_name') }}"
                                       placeholder="Ex: Cosmos ardent"
                            ...
                            <div>
                                ...
                                <input type="text" name="passive_ability_description" id="passive_ability_description" value="{{ old('passive_ability_description') }}"
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="image_primary" class="block text-sm font-medium text-gray-300 mb-2">Image principale</label>
                            ...
                            <div>
                                <label for="image_secondary" class="block text-sm font-medium text-gray-300 mb-2">Image alternative</label>
                    ...
                    <div class="flex gap-4 pt-6 border-t border-white/20">
                        <button type="submit" class="flex-1 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold text-lg rounded-lg hover:from-purple-500 hover:to-indigo-500 transition transform hover:scale-[1.02]">
                            ✅ Créer la carte
                        </button>
                        <a href="{{ route('cards.index') }}" class="px-8 py-4 bg-gray-600 text-white font-bold rounded-lg hover:bg-gray-500 transition">
                            Annuler
                        </a>
                    </div>
                </form>
